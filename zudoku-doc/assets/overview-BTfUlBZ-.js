import{J as t,j as e}from"./entry.client-172Ys3p0.js";const d="Документ описывает требования к авторизации для каждого эндпоинта согласно анализу локально развернутых Swagger UI и официальной Postman-коллекции к restful-booker-platform.",s=[{depth:1,value:"Матрица доступа к API Restful-Booker-Platform",id:"матрица-доступа-к-api-restful-booker-platform",children:[{depth:2,value:"Важные замечания по авторизации",id:"важные-замечания-по-авторизации"},{depth:2,value:"Сервис: Auth (Аутентификация)",id:"сервис-auth-аутентификация"},{depth:2,value:"Сервис: Booking (Бронирования)",id:"сервис-booking-бронирования"},{depth:2,value:"Сервис: Room (Комнаты)",id:"сервис-room-комнаты"},{depth:2,value:"Сервис: Message (Сообщения)",id:"сервис-message-сообщения"},{depth:2,value:"Сервис: Branding (Брендирование)",id:"сервис-branding-брендирование"},{depth:2,value:"Сервис: Report (Отчёты)",id:"сервис-report-отчёты"}]}],c={lastModifiedTime:"2026-01-04T15:51:41.000Z"},h="pages/overview.mdx";function r(i){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",h1:"h1",h2:"h2",hr:"hr",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx("script",{dangerouslySetInnerHTML:{__html:`
...
//# sourceMappingURL=overview-BTfUlBZ-.js.map
